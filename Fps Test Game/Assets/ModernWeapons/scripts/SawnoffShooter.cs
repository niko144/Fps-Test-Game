...
public class SawnoffShooter : MonoBehaviour
{
    ...
    public AnimationClip reload1Anim;
    ...
    public Transform particlesmuzzle1;
    public Transform muzzle2;
    public Transform particlesmuzzle2;
    ...
    void reload()
    {
        ...
        if (canreload && !isreloading)
        {
            ...
            if (currentammo > 0)
            {
                StartCoroutine(setreload(myanimation[reload1Anim.name].length));
                myAudioSource.pitch = 1f;
                myAudioSource.clip = reloadSound;
                myAudioSource.loop = false;
                myAudioSource.volume = 1;
                myAudioSource.Play();
                myanimation.Play(reload1Anim.name);
    ...
    IEnumerator flashthemuzzle()
    {
        ...
        if (currentammo > 0)
        {
            ...
            particleSystems = particlesmuzzle2.GetComponentsInChildren<ParticleSystem>();
        ...
        {
            ParticleSystem[] particleSystems;
            particleSystems = particlesmuzzle1.GetComponentsInChildren<ParticleSystem>();
            foreach (ParticleSystem particle in particleSystems)
            {
                particle.Play();
            }
